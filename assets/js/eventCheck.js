...
function eventCheck(){
    ...
    const eventParticipantsNbr = document.getElementById('eventParticipantsNbr').value;
    ...
    if (isNaN(eventParticipantsNbr) || eventParticipantsNbr < 1 || eventParticipantsNbr > 60) {
        error("Le nombre de joueur doit être compris entre 1 et 60", "eventParticipantsNbr");
        return false;
    }
